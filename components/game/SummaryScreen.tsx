...
export const SummaryScreen: React.FC<SummaryScreenProps> = ({ state, onRestart }) => {
  return (
    <LayoutShell className="p-4 md:p-6 text-center bg-[#051a0d]">
      <div className="w-full max-w-2xl">
        ...
        <button onClick={onRestart} className="px-6 py-3 md:px-16 md:py-5 text-base md:text-2xl font-black tracking-wide bg-green-600 text-white hover:bg-white hover:text-green-600 transition-all shadow-xl min-h-[40px] md:min-h-[48px]">
          Log off
        </button>
      </div>
    </LayoutShell>
