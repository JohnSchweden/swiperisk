  ...
  return (
    <LayoutShell className="p-4 md:p-6 text-center bg-[#1a0505]">
      <div className="w-full max-w-2xl">
        ...
        <button onClick={onRestart} className="px-6 py-3 md:px-12 md:py-4 text-base md:text-xl font-bold tracking-wide bg-white text-red-600 hover:bg-red-600 hover:text-white transition-all duration-300 transform hover:scale-105 min-h-[40px] md:min-h-[48px]">
          Reboot system
        </button>
      </div>
    </LayoutShell>
