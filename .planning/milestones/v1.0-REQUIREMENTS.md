# Requirements Archive: v1.0 UI/UX Improvements
...
- [x] ~~**SWIPE-02**: Card lift effect on drag start~~
...
**Shipped:** 12 of 13 v1 requirements (SWIPE-02 removed per user decision)

**Adjusted:** None

**Dropped:**
- SWIPE-02 (Card lift on drag start) — Removed per user decision, keeping swipe interactions simple

**Known Limitation:**
- Lighthouse CLI encountered NO_FCP error during automated testing (environment limitation). All PERF-01 optimizations verified in code. Manual Chrome DevTools audit recommended for Lighthouse score confirmation.
