...
const TONE_INSTRUCTIONS: Record<string, string> = {
  ...
  ZEN_MASTER: "Be calm, meditative, and passive-aggressive. Zen koans and flowing-water metaphors. Softly devastating.",
  LOVEBOMBER: "Be high-energy, hype, and Silicon Valley influencer style. Exclamation points. 'Slay,' 'literally,' 'vibes.'",
};
